...
class UnitManager:
    ...
    def nextTime(self, water_flow):
        ...
        if water_flow > upper_threshold and len(self.work_large_unit) != 2:
            change = True
        ...
        #     todo  小流量但没有45机组
        elif water_flow < lower_threshold and len(self.work_small_unit) != 1:
            change = True
...
if __name__ == '__main__':
    ...
    # 打开文本文件并读取 "出站流量" 列数据
    with open('E:\Code\pythonProject4\merged_data4.txt', 'r', encoding='UTF8') as file:
        # 跳过文件的首行（假设首行是列头）
        ...
        for line in lines[1:]:
            ...
            flow_data = float(data_columns[7])+7000
            um.nextTime(flow_data)

print('finish')

# # def nextTime(self, water_flow):  um实例化
# for i in range(1, 10000):
#     um.nextTime(int(math.sin((math.pi * 2) / 1000 * i) * 3000 + 7000))
# print('finish')
